...
function delete_photo(obj,id){
	...
	layer.confirm('确认要删除吗？',function(index){
		$.get("/admin/photo/delete",data,function(data){
...
function delete_ada(obj,id){
	var data = {id : id};
	layer.confirm('确认要删除吗？',function(index){
		$.get("/admin/advantage/delete",data,function(data){
			$(obj).parents("tr").remove();
			layer.msg('已删除!',{icon:1,time:2000});
		})
	});
...
function delete_room(obj,id){
	var data = {id : id};
	layer.confirm('确认要删除吗？',function(index){
		$.get("/admin/room/delete",data,function(data){
			$(obj).parents("tr").remove();
			layer.msg('已删除!',{icon:1,time:2000});
		})
	});
...
function delete_image(obj,id){
	var data = {id : id};
	layer.confirm('确认要删除吗？',function(index){
		$.get("/admin/image/delete",data,function(data){
			$(obj).parents("tr").remove();
			layer.msg('已删除!',{icon:1,time:2000});
		})
	});
...
function delete_order(obj,id){
	var data = {id : id};
	layer.confirm('确认要删除吗？',function(index){
		$.get("/admin/order/delete",data,function(data){
			$(obj).parents("tr").remove();
			layer.msg('已删除!',{icon:1,time:2000});
		})
	});
